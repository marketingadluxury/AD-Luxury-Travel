...
- **Quyền truy cập Điều Hành Chiến Lược:** Tính năng "Điều hành chiến lược" (`/dashboard/executive`) chỉ hiển thị và cho phép truy cập đối với vai trò **Quản trị viên (`admin`)**. Các vai trò khác sẽ không thấy mục này trên Sidebar và không có quyền truy cập.
